...
//añadido para graph//------------------------------
	...
	{		
		...
		Htot[k] = Htot[k] + (1/F[k]); // Sumamos los factores de corrección para mostrar su comportamiento general
	}
	memcpy(output1, Htot, sizeof(_Complex float)*DATAsize); //output para visualizar los factores y su comportamiento
	cont++;
